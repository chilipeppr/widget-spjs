        ...
        checkLogin: function() {
          ...
          var jqxhr = $.ajax({
              ...
              if (data.CurrentUser != undefined && data.CurrentUser != null) {
                ...
                $('#com-chilipeppr-serialport-modalconfig .alert-warning').text("User logged in as " + that.currentUser);
                ...
                $('#com-chilipeppr-serialport-modalconfig .alert-warning').text("User not logged in so can't show saved configs.");
